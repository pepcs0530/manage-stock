...
function saveCustomer(connection, req, res, callback) {
  async.waterfall([
      function (callback) {
        console.log('customer_id-->', req.body.customer.customer_id)
        if (req.body.customer.customer_id == null) {
          ...
          connection.query(sqlStr, function (err, result) {
            ...
            console.log("saveCustomer id null-->", id)
      ...
      function (id, callback) {
        ...
        req.body.customer.customer_id = id;
        console.log("saveCustomer req.body.customer.customer_id-->", req.body.customer.customer_id)
  ...
  async.waterfall([
      ...
      function (callback) {
        ...
        connection.query(sqlStr, function (err, result) {
          ...
          console.log("saveOrderDetails result-->", result)
          ...
          /* var cusLastId = result.length !== 0 ? result[0]['customer_id'] : 'P000000000';
          var id = 'C' + (parseInt(cusLastId.substring(1, 10)) + 1).toString().padStart(9, '0');
          console.log("order cusId-->", cusId) */
